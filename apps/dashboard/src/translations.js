...
const en = {
  ...
  floristRatesHint:         'Default hourly rate per florist (zł/h) — used for salary calculation',
...
const ru = {
  ...
  floristRatesHint:         'Ставка по умолчанию для каждого флориста (zł/ч) — для расчёта зарплаты',
