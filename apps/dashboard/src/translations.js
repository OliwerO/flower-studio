...
const en = {
  ...
  correctCountDone: 'Done',
  window2w:         '2 wk',
  window1m:         '1 mo',
  windowAll:        'All',
  traceWindowFolded: 'earlier events folded in',
  ...
  flowerType:       'Type',
  flowerColour:     'Colour',
  flowerCultivar:   'Cultivar',
  flowerSizeCm:     'Size cm',
  ...
  fillAllFields:      'Fill flower name and qty',
  ...
  packages:           'Pkgs',
  variety:            'Variety',
  driverNote:         'Note for the driver',
  driverNotePlaceholder: 'e.g. pay in cash, stall on the left',
  cancelPO:           'Cancel',
  cancelPOConfirm:    'Cancel this purchase run? The driver will be told.',
  poCancelled:        'Purchase run cancelled',
  poCancelledToReviewing: 'Cancelled — already-bought lines moved to review',
  cancelLine:         'Cancel this line',
  removeLine:         'Remove',
  lineCancelled:      'cancelled',
  varietyLinked:      'from stock card',
  varietyNone:        'not selected',
  newVariety:         'New variety',
  receivesInto:       'receives into',
  changeFlowerHint:   'To change the flower, remove this line and add a new one',
  ...
  explorer: {
    title:        'Data Explorer',
    subtitle:     'Read-only · linked records',
    entity:       'Entity',
    pickEntity:   'Choose an entity',
    groupBy:      'Group by',
    noGroup:      'No grouping',
    countLabel:   'Count',
    saveView:     'Save view',
    ...
    contains:     'contains…',
    noData:       'No data',
    loadError:    'Failed to load Explorer',
    showing:      'Showing',
    of:           'of',
    truncatedNote:'capped at 200',
    saveError:    'Could not save view',
    chain:        'Deep-join',
    chainExit:    'Exit deep-join',
    chainPath:    'Path:',
...
const ru = {
  ...
  correctCount:     'Исправить остаток',
  correctCountDone: 'Готово',
  window2w:         '2 нед',
  window1m:         '1 мес',
  windowAll:        'Все',
  traceWindowFolded: 'ранних событий свёрнуто',
  ...
  flowerType:       'Тип',
  flowerColour:     'Цвет',
  flowerCultivar:   'Культивар',
  flowerSizeCm:     'Размер см',
  ...
  fillAllFields:      'Заполните название и количество',
  ...
  packages:           'Пачки',
  variety:            'Сорт',
  driverNote:         'Записка водителю',
  driverNotePlaceholder: 'напр. оплата наличными, палатка слева',
  cancelPO:           'Отменить',
  cancelPOConfirm:    'Отменить закупку? Водитель получит уведомление.',
  poCancelled:        'Закупка отменена',
  poCancelledToReviewing: 'Отменено — уже купленное отправлено на проверку',
  cancelLine:         'Отменить позицию',
  removeLine:         'Удалить',
  lineCancelled:      'отменено',
  varietyLinked:      'из карточки склада',
  varietyNone:        'не выбран',
  ...
  explorer: {
    ...
    contains:     'содержит…',
    noData:       'Нет данных',
    loadError:    'Не удалось загрузить Обозреватель',
    showing:      'Показано',
    of:           'из',
    truncatedNote:'ограничено до 200',
    saveError:    'Не удалось сохранить вид',
    chain:        'Связи',
    chainExit:    'Выйти из связей',
    chainPath:    'Путь:',
