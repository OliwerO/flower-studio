...
const en = {
  ...
  poLate:              'PO arrives after the needed date',
  poLateShort:        'late',
  shortfallHint:       '−N = stems short for that date · "+N late" = N on order but arriving after it',
  today:               'Today',
  tomorrow:            'Tomorrow',
  daysSuffix:          'd',
  ...
  // Issues tab (GitHub issue tracker)
  tabIssues:                    'Issues',
  issuesTitle:                  'GitHub Issues',
  issuesOpen:                   'Open',
  issuesClosed:                 'Closed',
  issuesAll:                    'All',
  issuesSearch:                 'Search issues...',
  issuesNewIssue:               'New issue',
  issuesNoResults:              'No issues found.',
  issuesLoading:                'Loading issues...',
  issuesError:                  'Failed to load issues.',
  issuesCommentCount:           'comments',
  issuesDateToday:              'today',
  issuesDateYesterday:          'yesterday',
  issuesDateDaysAgo:            'days ago',
  issuesDateWeeksAgo:           'weeks ago',
  issuesPriorityHigh:           'High',
  issuesPriorityMedium:         'Medium',
  issuesPriorityLow:            'Low',
  issuesPriorityNone:           'No priority',
  issuesPriorityLabel:          'Priority',
  issuesPrioritySet:            'Set priority',
  issuesLabelAdd:               'Add label',
  issuesLabelRemove:            'Remove',
  issuesLabels:                 'Labels',
  issuesNoLabels:               'No labels',
  issuesComments:               'Comments',
  issuesNoComments:             'No comments yet.',
  issuesAddComment:             'Write a comment...',
  issuesPostComment:            'Post',
  issuesPosting:                'Posting...',
  issuesCommentPosted:          'Comment posted',
  issuesCommentFailed:          'Failed to post comment',
  issuesCloseIssue:             'Close issue',
  issuesReopenIssue:            'Reopen issue',
  issuesClosing:                'Closing...',
  issuesReopening:              'Reopening...',
  issuesIssueClosed:            'Issue closed',
  issuesIssueReopened:          'Issue reopened',
  issuesUpdateFailed:           'Update failed',
  issuesCreateTitle:            'New issue',
  issuesCreateTitlePlaceholder: 'Issue title',
  issuesCreateBodyPlaceholder:  'Describe the issue or feature request...',
  issuesCreateLabelsHint:       'Labels',
  issuesCreateSubmit:           'Create issue',
  issuesCreating:               'Creating...',
  issuesCreated:                'Issue created',
  issuesCreateFailed:           'Failed to create issue',
  issuesSelectToView:           'Select an issue to view details.',
  issuesViewOnGitHub:           'View on GitHub',
  issuesByLabel:                'Filter by label',
  issuesFilterAll:              'All labels',
  issuesStatusBadgeOpen:        'Open',
  issuesStatusBadgeClosed:      'Closed',
  ...
  // Variety backfill tab (issue #292)
  tabBackfill:                  'Variety Backfill',
  backfillTitle:                'Variety Attribute Backfill',
  backfillBannerNone:           'All Stock Items have been backfilled.',
  backfillBannerRemaining:      'still need backfill',
  backfillBannerOf:             'of',
  backfillColLegacyName:        'Legacy Name',
  backfillColType:              'Type',
  backfillColColour:            'Colour',
  backfillColSize:              'Size (cm)',
  backfillColCultivar:          'Cultivar',
  backfillSave:                 'Save',
  backfillSaving:               'Saving...',
  backfillSaved:                'Saved',
  backfillSaveFailed:           'Save failed',
  backfillToggleShowAll:        'Show backfilled',
  backfillToggleHideAll:        'Pending only',
  backfillTypeRequired:         'Type is required',
  backfillBulkPanel:            'Bulk edit',
  backfillBulkFilter:           'Filter by name...',
  backfillBulkApply:            'Apply to selected',
  backfillBulkApplying:         'Applying...',
  backfillBulkApplied:          'Applied to',
  backfillBulkRows:             'rows',
  backfillBulkNoneSelected:     'Select rows with the checkbox to bulk-edit',
  ...
  // ── Y-model Stock list strings (Task 11) ──
  onHand:                       'On hand',
  reserved:                     'In premade',
  net:                          'Net',
  premade:                      'Premade',
...
const ru = {
  ...
  poLate:              'Поставка придёт позже нужной даты',
  poLateShort:        'поздно',
  shortfallHint:       '−N = не хватает к этой дате · "+N поздно" = N в пути, но прибудет позже',
  today:               'Сегодня',
  tomorrow:            'Завтра',
  daysSuffix:          'д',
  ...
  varietyType:        'Тип *',
  varietyColour:      'Цвет',
  varietySize:        'Длина (см)',
  varietyCultivar:    'Культивар',
  ...
  issuesTitle:                  'GitHub Issues',
  issuesOpen:                   'Открытые',
  issuesClosed:                 'Закрытые',
  issuesAll:                    'Все',
  issuesSearch:                 'Поиск задач...',
  issuesNewIssue:               'Новая задача',
  issuesNoResults:              'Задач не найдено.',
  issuesLoading:                'Загрузка задач...',
  issuesError:                  'Не удалось загрузить задачи.',
  issuesCommentCount:           'комм.',
  issuesDateToday:              'сегодня',
  issuesDateYesterday:          'вчера',
  issuesDateDaysAgo:            'дн. назад',
  issuesDateWeeksAgo:           'нед. назад',
  issuesPriorityHigh:           'Высокий',
  issuesPriorityMedium:         'Средний',
  issuesPriorityLow:            'Низкий',
  issuesPriorityNone:           'Без приоритета',
  issuesPriorityLabel:          'Приоритет',
  issuesPrioritySet:            'Установить приоритет',
  issuesLabelAdd:               'Добавить метку',
  issuesLabelRemove:            'Удалить',
  issuesLabels:                 'Метки',
  issuesNoLabels:               'Нет меток',
  issuesComments:               'Комментарии',
  issuesNoComments:             'Комментариев пока нет.',
  issuesAddComment:             'Написать комментарий...',
  issuesPostComment:            'Отправить',
  issuesPosting:                'Отправка...',
  issuesCommentPosted:          'Комментарий добавлен',
  issuesCommentFailed:          'Не удалось добавить комментарий',
  issuesCloseIssue:             'Закрыть задачу',
  issuesReopenIssue:            'Переоткрыть',
  issuesClosing:                'Закрытие...',
  issuesReopening:              'Открытие...',
  issuesIssueClosed:            'Задача закрыта',
  issuesIssueReopened:          'Задача переоткрыта',
  issuesUpdateFailed:           'Не удалось обновить',
  issuesCreateTitle:            'Новая задача',
  issuesCreateTitlePlaceholder: 'Заголовок задачи',
  issuesCreateBodyPlaceholder:  'Опишите проблему или пожелание...',
  issuesCreateLabelsHint:       'Метки',
  issuesCreateSubmit:           'Создать задачу',
  issuesCreating:               'Создание...',
  issuesCreated:                'Задача создана',
  issuesCreateFailed:           'Не удалось создать задачу',
  issuesSelectToView:           'Выберите задачу для просмотра.',
  issuesViewOnGitHub:           'Открыть на GitHub',
  issuesByLabel:                'Фильтр по метке',
  issuesFilterAll:              'Все метки',
  issuesStatusBadgeOpen:        'Открыта',
  issuesStatusBadgeClosed:      'Закрыта',
  ...
  // Variety backfill tab (issue #292)
  tabBackfill:                  'Заполнение сортов',
  backfillTitle:                'Заполнение атрибутов сорта',
  backfillBannerNone:           'Все позиции склада заполнены.',
  backfillBannerRemaining:      'ещё требуют заполнения',
  backfillBannerOf:             'из',
  backfillColLegacyName:        'Старое название',
  backfillColType:              'Вид',
  backfillColColour:            'Цвет',
  backfillColSize:              'Размер (см)',
  backfillColCultivar:          'Сорт',
  backfillSave:                 'Сохранить',
  backfillSaving:               'Сохранение...',
  backfillSaved:                'Сохранено',
  backfillSaveFailed:           'Ошибка сохранения',
  backfillToggleShowAll:        'Показать заполненные',
  backfillToggleHideAll:        'Только незаполненные',
  backfillTypeRequired:         'Вид обязателен',
  backfillBulkPanel:            'Массовое редактирование',
  backfillBulkFilter:           'Фильтр по названию...',
  backfillBulkApply:            'Применить к выбранным',
  backfillBulkApplying:         'Применение...',
  backfillBulkApplied:          'Применено к',
  backfillBulkRows:             'строк',
  backfillBulkNoneSelected:     'Выберите строки флажком для массового редактирования',
