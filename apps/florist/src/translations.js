...
const en = {
  ...
  po: {
    ...
    cancelPO:        'Cancel',
    cancelConfirm:   'Cancel this purchase run? The driver will be told.',
    cancelled:       'Purchase run cancelled',
    cancelledToReviewing: 'Cancelled — already-bought lines moved to review',
...
const ru = {
  ...
  po: {
    ...
    cancelPO:        'Отменить',
    cancelConfirm:   'Отменить закупку? Водитель получит уведомление.',
    cancelled:       'Закупка отменена',
    cancelledToReviewing: 'Отменено — уже купленное отправлено на проверку',
    cancelLine:      'Отменить позицию',
    removeLine:      'Удалить',
    lineCancelled:   'отменено',
    cancelledStatus: 'Отменён',
    showCancelled:   'Показать отменённые',
