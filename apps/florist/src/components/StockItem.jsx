...
export default function StockItem({ item, onAdjust, onWriteOff }) {
  ...
  return (
    <div>
      ...
      {/* Write-off inline form — slides in below the stock row */}
      {showWriteOff && (
        <div className="flex items-center gap-3 px-4 pb-3 pt-0 ml-5">
          ...
          <button
            onClick={() => { setShowWriteOff(false); setWriteOffQty(1); }}
