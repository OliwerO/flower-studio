// HelpPanel — bottom-sheet FAQ accordion.
// Tap "?" in the nav bar to open; tap outside or ✕ to close.
// Single-expand: only one answer visible at a time (keeps it tidy).

import { useState } from 'react';
import guide from '../guideContent.js';

export default function HelpPanel({ onClose }) {
  const [openIdx, setOpenIdx] = useState(null); // "sectionIdx-itemIdx"
